# !!! This repository is deprecated as most of the work done here is already part of the official Spring Cloud DataFlow Tensorflow Application: https://github.com/tzolov/tensorflow !!!

 ...
 */
public class LabelImageTensorflowInputConverter implements TensorflowInputConverter, AutoCloseable {

	private static final Log logger = LogFactory.getLog(LabelImageTensorflowInputConverter.class);
